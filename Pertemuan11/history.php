    ...
    <div class="container mt-5">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM transaksi JOIN user ON transaksi.user_id = user.user_id JOIN produk ON transaksi.produk_id = produk.produk_id WHERE transaksi.user_id = '$user' ORDER BY transaksi.tanggal DESC";
