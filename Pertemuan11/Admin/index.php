            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="../history.php">Riwayat Pembelian</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <!-- Modal ubah data -->
                                <div class="modal fade" id="editDataModal<?= $data['transaksi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editDataModalLabel" aria-hidden="true">
                                            ...
                                            <form method="POST" action="transaksi/ubah.php">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="produk" name="produk_id" disabled>
                                                            <?php
                                                            $produk = $conn->query("SELECT * FROM produk");
                                                            foreach ($produk as $data1) : ?>
                                                                <option value="<?= $data1['produk_id'] ?>" <?php if ($data['produk_id'] == $data1['produk_id']) {
                                                                                                                echo "selected";
                                                                                                            } ?>><?= $data1['nama'] ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="number" class="form-control" id="jumlah" name="qty" value="<?= $data['quantity'] ?>">
                                                    </div>
