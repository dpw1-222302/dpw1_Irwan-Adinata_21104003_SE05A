...
?>
                        ...
                        <div class="mb-3">
                            <input type="nohp" class="form-control" name="nohp" placeholder="No HP">
                        </div>

                        <button type="submit" name="register" class="btn btn-primary" style="width: 100%;">Sign up</button>
                        <p style="color: gray; font-size: 13px; padding-top: 5px; margin-bottom: 0; text-transform: capitalize;">have an account?
                        <a href="login.php" style="color: teal;">Login now</a></p>
                    </form>
                </div>
            </div>
        </div>
