          ...
          <div class="card-body">
            ...
            <form action="proses_register.php" method="POST">
              <div class="form-group">
                ...
                <input required type="text" class="form-control" id="user" placeholder="Masukan nama lengkap"
                  name="user">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input required type="password" class="form-control" id="pass" placeholder="masukan pass" name="pass">
              </div>
